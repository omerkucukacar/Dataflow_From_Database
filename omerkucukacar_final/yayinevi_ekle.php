...
<form action="yayinevi_eklendi.php" method="post" >
    Yayınevi Adı: <input type="text" name="yya" style="position:relative;left:15px"><br><br>
    Yayınevi URL: <textarea name="yyu" rows="2" cols="50" style="position:relative;left:10px"></textarea><br><br>
    Yazar E-posta : <input type="text" name="yye" ><br><br>
   
    <input type="submit" value="Yeni Yayınevi Ekle" style="text-align:center;background-color:#212121; color: white">
</form>
<!-- KODLAR -->   
</main>
