<?php
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yazarveri WHERE yazarkayitno = $guncellenecek");
...
<form action="yazar_guncellendi.php" method="post">
    ...
    <input type="submit" value="Yazar Güncelle" style="text-align:center;background-color:#212121; color: white">
</form>
<!-- KODLAR -->   
</main>
