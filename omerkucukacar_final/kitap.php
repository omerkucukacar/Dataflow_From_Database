...
$sorgu = mysqli_query($baglanti, "SELECT A.kkn, A.kkt, A.ki, A.ka, A.kf, A.kadet, A.kbyeri, A.kbtarih, A.kdili, CONCAT(B.ya,' ', B.ys) AS AdSoyad, C.yya FROM kitapveri A, yazarveri B, yayinevi C  WHERE A.yykn = C.yykn AND A.yazarkayitno = B.yazarkayitno ");
...
<p><a href="kitap_ekle.php" style="text-align:center;background-color:#212121; color: white">Yeni Kitap Ekle</a></p>
<?php
