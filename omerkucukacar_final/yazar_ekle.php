...
<form action="yazar_eklendi.php" method="post">
    Yazar Adı: <input type="text" name="ya" style="position:relative;left:25px"><br><br>
    Yazar Soyadı: <input type="text" name="ys"><br><br>
    Yazar URL: <textarea name="yu" rows="2" cols="50" style="position:relative;left:20px"></textarea><br><br>
    <input type="submit" value="Yeni Yazar Ekle" style="text-align:center;background-color:#212121; color: white">
</form>
<!-- KODLAR -->   
</main>
...
<br>
      ...
      <br>
      <br>
      <footer style="text-align:center;background-color:#212121; color: white;padding:10px"><b>Yazar İşlemleri</b></footer>
</body>
</html>