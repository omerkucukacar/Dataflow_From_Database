<?php
    ...
    $sorgu = "INSERT INTO yayinevi (yya, yyu, yye)
            VALUES ('$yya', '$yyu', '$yye')";
...
<p><a href="yayinevi_ekle.php" style="text-align:center;background-color:#212121; color: white">Yeni Yayınevi Ekle</a></p>
<?php
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td><a href='yayinevi_sil.php?yykn=".$satir["yykn"]."'>Sil</a></td>");
    echo("</tr>");
            }
echo("</table>");
?>
