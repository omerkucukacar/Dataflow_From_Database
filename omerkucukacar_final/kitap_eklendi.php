<?php
    ...
    $sorgu = "INSERT INTO kitapveri (ki, ka, kf, kadet, kbyeri, kbtarih, kdili, yykn, yazarkayitno)
            VALUES ('$ki', '$ka', '$kf', '$kadet', '$kbyeri', '$kbtarih', '$kdili', '$yykn', '$yazarkayitno')";
