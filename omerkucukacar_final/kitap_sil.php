<?php
    ...
    $silinecek = mysqli_real_escape_string($baglanti, $_GET["kkn"]);
    $sorgu = "DELETE FROM kitapveri WHERE kkn = '$silinecek'";
...
<meta name="theme-color" content="#563d7c">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    ...
    <form class="form-inline mt-2 mt-md-0">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="Search">Arama</button>
    </form>
  </div>
</nav>
