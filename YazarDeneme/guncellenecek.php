<?php
    ...
    $guncellenecek = mysqli_real_escape_string($baglanti, $_GET["ykn"]);
    $sorgu = mysqli_query($baglanti, "SELECT * FROM yazarveri WHERE ykn = $guncellenecek");
...
<html lang="tr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>KATALOG KiTAPLARIM</title>
...
<form action="yazar_guncellendi.php" method="post">
    Yazar Adı: <input type="text" name="ya" value="<?php echo $satir["ya"] ;?>"><br><br>
    Yazar Soyadı: <input type="text" name="ys" value="<?php echo $satir["ys"] ;?>"><br><br>
    Yazar URL: <textarea name="yu" rows="2" cols="50"><?php echo $satir["yu"]?></textarea><br><br>
    <input type="hidden" value="<?php echo $satir["ykn"] ;?>" name="ykn">
