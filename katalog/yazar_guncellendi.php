<?php
    ...
    $ykn = mysqli_real_escape_string($baglanti, $_POST['ykn']);    
    ...
    $sorgu = "UPDATE yazarveri SET ya = '$ya', ys = '$ys', yu = '$yu' WHERE ykn = $ykn";
    ...
    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM yazarveri ORDER BY ykn DESC");
