...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 01 Ara 2020, 18:13:04
...
,`Eser` varchar(300)
,`Yazar` varchar(251)
,`YazarHakkinda` varchar(100)
,`Tarih` year(4)
,`BasimYeri` varchar(50)
,`Sayfa` varchar(50)
,`Dil` varchar(100)
,`Adet` int(11)
,`Yayinevi` varchar(100)
,`YayineviURL` varchar(100)
,`YayineviEposta` varchar(100)
);
...
CREATE TABLE `kitapveri` (
  ...
  `KitapBasimYeri` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Kitabın oluşturulduğu yer',
...
INSERT INTO `kitapveri` (`KitapKayitNo`, `KitapKayitTarih`, `KitapİSBN`, `KitapAdi`, `KitapFiziksel`, `KitapAdet`, `KitapBasimYeri`, `KitapBasimTarih`, `KitapDili`, `yayineviKayitNo`, `yazarKayitNo`) VALUES
...
--
ALTER TABLE `yayinevi`
  MODIFY `yayineviKayitNo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Yayınevi bilgilerinin anahtar numarası', AUTO_INCREMENT=17;

--
-- Tablo için AUTO_INCREMENT değeri `yazarveri`
--
ALTER TABLE `yazarveri`
  MODIFY `yazarKayitNo` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Yazar Tablosunun Anahtar alanı', AUTO_INCREMENT=20;
COMMIT;
